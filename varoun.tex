...
\section{Experience}
{\bf Founder,} GrokLogs, Bangalore. \hfill Jan 2011 - present
 \begin{itemize} \itemsep -2pt %reduce space between items
 \item GrokLogs is a recommender system as a service startup. Handled
   multiple roles including writing all code (backend engine, RESTful
   webservices interface), \\ production operations, and business/customer 
   development.
 ...
 \item Incident Manager and Tier2 engineer at the Yahoo! Network Operations 
   Center / Operations Center. Responsibilities included triage, taking full 
   ownership of production outages, coordinating the efforts of the 
   different teams involved in the resolution  process and communicating the 
   current status to senior management and partners.
